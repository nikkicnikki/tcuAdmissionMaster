...
Route::middleware([
    ...
    Route::get('/settings/{examtime}/edit_time', [SettingController::class, 'examTimeEdit'])->name('time.edit');
    ...
    Route::put('/settings/update_time/{examtime}', [SettingController::class, 'examTimeUpdate'])->name('time.update');

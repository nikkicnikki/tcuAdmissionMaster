                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                        <div className="p-6 text-gray-900 dark:text-gray-100 shadow-lg ">
                            ...
                            <div className="mt-5">
                                <p className="mt-1">
                                    <label className="font-bold text-lg">Create : </label>
                            ...
                            <div className="mt-1">
                                <p className="mt-1">
                                    <label className="font-bold text-lg">Update : </label>
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                        <div className="p-6 text-gray-900 dark:text-gray-100 shadow-lg ">
                            ...
                            <div className=" text-right">
                                ...
                                <Link
                                    //href={route("applicant.index")}
                                    className="bg-blue-500 ml-2 py-2 px-3 text-white rounded shadow transition-all hover:bg-blue-800 "
                                >
                                    UPDATE
                                </Link>
                            </div>
